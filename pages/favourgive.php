    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-xs-12 main-content-area-subpages">
          ...
          <h2>Your owe the following favour!</h2>
          <br>
          <h3>Your partner has traded points and won:</h3>
          <br>

           <textarea type="text" class="form-control" id="favourpartner" readonly rows="5">Description of your prize goes here. Description of your prize goes here. Description of your prize goes here.</textarea>
       <br>
       <h4>You have the following amount of time to complete the favour or they will get another one for free!</h4>
       <br>
