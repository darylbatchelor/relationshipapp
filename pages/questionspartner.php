...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse navbar-right collapse">
          ...
          <ul class="nav navbar-nav color-scheme">
            ...
            <li class="active"><a href="questionsyou.php">Questions</a></li> 
    ...
    <div class="color-scheme">
      <div class="row">
        <div class="col-xs-4 tab-parent">
          <a class="tab" href="questionsyou.php">About you</a>
          <div class="tab-child"></div>
        </div>
        <div class="col-xs-4 tab-parent">
          <a class="tab" href="questionspartner.php">Partner</a>
          <div class="tab-child tab-active"></div>
        </div>
        <div class="col-xs-4 tab-parent">
          <a class="tab" href="questionsresult.php">Result</a>
          <div class="tab-child"></div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-xs-12 main-content-area-subpages">
          ...
          <h2>How well do you know your partner?</h2>
           ...
           <form role="form">
              <!-- need to loop through questions that have not been answered here-->
                <div class="form-group">
                  <label for="question1">Question one goes here?</label>
                  <input type="text" class="form-control" id="question1">
                </div>
                <div class="form-group">
                  <label for="question2">Question two goes here?</label>
                  <input type="text" class="form-control" id="question2">
                </div>
                <div class="form-group">
                  <label for="question3">Question three goes here?</label>
                  <input type="text" class="form-control" id="question3">
                </div>
                <div class="form-group">
                  <label for="question4">Question four goes here?</label>
                  <input type="text" class="form-control" id="question4">
                </div>
                <div class="form-group">
                  <label for="question5">Question five goes here?</label>
