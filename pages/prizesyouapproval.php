           ...
           <form role="form">
              <!-- need to loop through questions that have not been answered here-->
                <div class="form-group">
                  <label for="yourprize">Your Weekly prize:</label>
                  <textarea type="text" class="form-control" readonly id="yourprize" rows="5">Description of your prize goes here. Description of your prize goes here. Description of your prize goes here.</textarea>
