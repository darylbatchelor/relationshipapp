    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-xs-12 main-content-area-subpages">
          ...
          <h3>Has the favour been completed?</h3>

                <div class="form-group">
                  
                  <input type="checkbox" id="favourcomplete" data-toggle="toggle" data-on="Yes" data-off="No" data-onstyle="primary" data-offstyle="default">
                </div>
