      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse navbar-right collapse">
          ...
          <ul class="nav navbar-nav color-scheme">
            ...
            <li class="active"><a href="detailsyou.php">Details</a></li> <hr>
    ...
    <div class="color-scheme">
      <div class="row">
        <div class="col-xs-6 tab-parent">
          <a class="tab" href="detailsyou.php">Your Details</a>
          <div class="tab-child"></div>
        </div>
        <div class="col-xs-6 tab-parent">
          <a class="tab" href="detailspartner.php">Partner Details</a>
          ...
          <h2>Your Details</h2>
           ...
           <form role="form">
                ...
                <div class="form-group">
                  ...
                  <input type="date" readonly class="form-control" id="anniversary">
                </div>
